  ...
  return (
    <div>
        <section className='groupcards1'>
            <div className="img1"><img src="https://i.pinimg.com/originals/b0/e5/04/b0e5041d005636563da50cd111d9c80e.jpg" alt='Office' height={379} width={380} className='zoom-img'/></div>
            ...
            <div className="img2"><img src="https://img.freepik.com/premium-photo/laptop-is-open-display-brand-new-technology_976564-6685.jpg" alt="automobiles" srcset="" height={379} width={380} className='zoom-img'/>
            </div>
        ...
        <section className='groupcards2'>
            ...
            <div className="img3"><img src="https://tse1.explicit.bing.net/th/id/OIP.SmvW6d6ww4_ueMurxv415wHaHa?rs=1&pid=ImgDetMain&o=7&rm=3 " alt="together"  height={379} width={380} className='zoom-img'/></div>
            ...
            <div className="img4"><img src="https://tse2.mm.bing.net/th/id/OIP.wbQkqjgeuyuAuYf5Bah5UgHaHa?rs=1&pid=ImgDetMain&o=7&rm=3" alt="team" height={379} width={380} className='zoom-img'/></div>
        ...
        <section className='groupcards3'>
            ...
            <div className="img6"><img src="https://tse4.mm.bing.net/th/id/OIP.buR4_KhPjYdp5IZVGREsRgHaJ4?pid=ImgDet&w=474&h=632&rs=1&o=7&rm=3" alt="build" height={379} width={380} className='zoom-img'/></div>
